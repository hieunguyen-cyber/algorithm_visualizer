...
/**
 * A* with no pruning - behaves like Dijkstra.
 * This variant doesn't prune the closed set, allowing re-exploration.
 */
public class AStarNoPruning {
    private Grid grid;
    ...
    public AStarNoPruning(Grid grid) {
        this.grid = grid;
    ...
    /**
     * Execute A* with no pruning algorithm with step-by-step tracking.
     * This is effectively Dijkstra's algorithm.
     */
